...
![what scrawl draws](examples/showcase.png)

**[The full showcase](examples/showcase.pdf)** — charts, bar graphs, linked
diagrams, roughness levels — shows every figure *beside the code that made
it*. The code shown is the code that ran: the page evaluates the same source
...
| `arrow(from, to, ..)` | a line with a solid head — `head`, `weight` |
